...
def main(args):
    ...
    metrics = evaluation.all_metrics(yhat_full, yy_dv, k=k, yhat_raw=yhat_full_raw)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--Y", type=int, help="size of label space, 'full' or '50'")
    parser.add_argument("--ngram", type=int, default=0, help="model")
